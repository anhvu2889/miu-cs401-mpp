...
public class TableExample extends JPanel implements LibWindow {
	...
	private UserControllerImpl systemController;
	...
	public void loadCheckoutRecord() {
		systemController = new UserControllerImpl();
		this.checkoutRecord = systemController.getAllCheckoutRecords();
		setTableValues();
		getTable().updateUI();
		setVisible(true);
	}
